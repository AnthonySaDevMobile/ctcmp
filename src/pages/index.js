...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="bg-black w-auto text-white text-center pt-14 pb-8">
      ...
      <div className="w-full flex justify-between items-center border border-none pt-10">
        <CarouselComponent />
      </div>
      ...
      <div className="w-full md:h-60 px-2 bg-bg-black-ct border-t-2 border-zinc-700">
        <div className="lg:w-9/12 lg:m-auto w-full  flex justify-between">
          <div className="md:w-1/2 w1/3">
            <p className="pt-10 text-white font-semibold rounded tracking-widest text-sm">
              NOSSO ESPAÇO
            </p>
            <p className="mt-5 text-white md:text-2xl text-base">
          ...
          <div className="flex justify-start h-48 items-center lg:w-1/4 md:w-1/3 bg-[url('../assets/whatsapp.png')] bg-cover bg-top bg-no-repeat ">
            <Link
              href="https://api.whatsapp.com/send?phone=38999337788"
              target="_blank"
            >
      ...
      <div className="w-full bg-bg-black-ct">
        <div className="lg:w-9/12 lg:px-0 px-2 flex flex-col items-center justify-center  m-auto pt-10">
