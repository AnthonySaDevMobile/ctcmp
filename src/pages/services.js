  ...
  return (
    <div>
      ...
      <div className="sm:pt-24 pt-24 w-full">
        ...
        <div className="sm:w-9/12 lg:m-auto w-full px-2 mt-10 flex justify-between">
          <div className="sm:leading-10 lg:w-5/12 pt-10 pb-10 ">
          ...
          <div className="flex right-0 absolute">
            <Image
              src={back5}
              alt="splash"
              className="sm:w-80 lg:h-auto w-80 h-80 lg:-mb-40 lg:-mr-36 -mb-48 hidden lg:flex mr-10  z-10"
            />
            <Image
              src={playPreto}
              alt="splash"
              width={400}
              className="-mt-24 h-96 z-20 hidden lg:flex"
            />
          </div>
        </div>
        <div className="w-full px-2 bg-bg-yellow-ct ">
          <div className="sm:w-9/12 lg:m-auto w-full">
            <div className=" text-2xl py-5 tracking-wide lg:w-1/2">
        ...
        <div
          className="sm:w-9/12 lg:m-auto w-full lg:flex py-20 lg:gap-10"
          id="structure"
        >
          <div className="sm:w-7/12">
            <strong className="bg-black text-white font-Montserrat-Bold rounded tracking-widest lg:text-sm px-2 ml-2 text-xs">
              NOSSA ESTRUTURA
            </strong>
            <p className="font-Montserrat-Bold lg:text-3xl text-2xl px-2 text-left mt-5 leading-10">
              Para produzir resultados de alta performance
            </p>
          </div>
          <div className=" lg:text-right text-lg px-2 lg:w-3/5 lg:pt-10 pt-5">
        ...
        <div className="bg-[url('../assets/serviços-fachada.png')] bg-cover bg-center w-full h-[] hover:opacity-80 hover:cursor-pointer transition-opacity duration-300 ">
